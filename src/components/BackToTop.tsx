    ...
    <AnimatePresence>
      {isVisible && (
        <motion.button
          ...
          className="fixed bottom-6 right-6 z-50 w-10 h-10 md:w-12 md:h-12 flex items-center justify-center bg-background border border-border dossier-panel cursor-pointer transition-colors hover:border-crimson hover:bg-crimson/5 group overflow-hidden"
